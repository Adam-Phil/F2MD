...
#"AppV2.dat" using (funcT($2)):(MCC($6,($7-$6),($5-$4),$4)) title "V2 MCC" with linespoints linestyle 2 lw 2 pi 30 ps 0.75 lc rgb "blue"
plot "AppV1.dat" using (funcT($2)):(MCC($6,($7-$6),($5-$4),$4)) title "MCC" with lines lw 2 lc rgb "red"

...
set label sprintf("V1 = %3.5gs,lastV1) at graph 0.02,0.95 tc rgb '#00bb00'

# "mdaV2.dat" using (funcT($2)):($8)  title 'V2 Latency' with linespoints linestyle 2 lw 2 pi 30 ps 0.75 lc rgb "blue"
plot "mdaV1.dat" using (funcT($2)):($8)  title 'V1 Latency' with lines lw 2 lt rgb "red"

...
# "mdaV2.dat" using (funcT($2)):(func3($6,$7))  title 'V2 Rate' with linespoints linestyle 2 lw 2 pi 30 ps 0.75 lc rgb "blue"
plot "mdaV1.dat" using (funcT($2)):(func3($6,$7))  title 'V1 Rate' with lines lw 2 lt rgb "red"
